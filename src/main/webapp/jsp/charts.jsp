...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            getRemoteDataDrawChart(contextPath + '/rest/charts/linechart1', createNewLineChart('chart1-container'));
            getRemoteDataDrawChart(contextPath + '/rest/charts/linechart2', createNewLineChart('chart2-container'));
            getRemoteDataDrawChart(contextPath + '/rest/charts/linechart3', createNewLineChart('chart3-container'));
        });
    </script>
</head>
<body>
